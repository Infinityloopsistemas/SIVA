...
var Dajaxice = {
    ...
    registrosRapidosEditar: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.registrosRapidosEditar', 'POST', callback_function, argv, custom_settings);
    },

    validaAnaliticas: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.validaAnaliticas', 'POST', callback_function, argv, custom_settings);
    },

    eventos: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.eventos', 'POST', callback_function, argv, custom_settings);
    },

    graficaregistros: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.graficaregistros', 'POST', callback_function, argv, custom_settings);
    },

    graficaentrada: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.graficaentrada', 'POST', callback_function, argv, custom_settings);
    },

    eventosHoy: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.eventosHoy', 'POST', callback_function, argv, custom_settings);
    },

    generaIncidenciaAnalitica: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.generaIncidenciaAnalitica', 'POST', callback_function, argv, custom_settings);
    },

    registrosRapidosGuardar: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.registrosRapidosGuardar', 'POST', callback_function, argv, custom_settings);
    },

    JsonImpRegPanel: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.JsonImpRegPanel', 'POST', callback_function, argv, custom_settings);
    },

    arbolCuadrosGestion: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.arbolCuadrosGestion', 'POST', callback_function, argv, custom_settings);
    },

    registrosRapidosNuevo: function(callback_function, argv, custom_settings){
        return Dajaxice.call('appcc.registrosRapidosNuevo', 'POST', callback_function, argv, custom_settings);
    }
