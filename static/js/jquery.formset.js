...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addText: 'añadir otro',          // Text for the add link
        deleteText: 'eliminar',            // Text for the delete link
        addCssClass: 'btn btn-link',          // CSS class applied to the add link
        deleteCssClass: 'icofont-trash',    // CSS class applied to the delete link
